function []=podmodes3dim(x,y,z,Xd, P,phi,freq, damping, Decimate,D,dirdmd,f)
...
close all
    ...
    for i=1:size(phistates,2)
        ...
        title(['POD mode ', num2str(mode), ' at hub height   |   St: ',num2str(round(freq(mode),4))...
        ...
        legend([p1 p3 p4 p5],['Isosurface of velocity ',num2str(first)],...
            ['Isosurface of velocity ',num2str(third)],...
             ['Isosurface of velocity ',num2str(fourth)],...
        ['Isosurface of velocity ',num2str(fifth)],'Location','bestoutside','Orientation','horizontal')
        legend('boxoff')
